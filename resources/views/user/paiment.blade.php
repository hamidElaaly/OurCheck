...
<div class="card mt-50 mb-50">
  ...
  <form action="{{url('Confirm_Payment ')}}" method="get">
      <span id="card-header">Cartes enregistrées :</span>
      <div class="row row-1">
      ...
      <div class="row-1">
          <div class="row row-2">
              <span id="card-inner">Nom du titulaire</span>
          </div>
          <div class="row row-2">
      ...
      <input type="hidden" name="price" value="{{$data->proprity}}">
      <button class="btn d-flex mx-auto"><b>Ajouter une carte</b></button>
  </form>
</div>
