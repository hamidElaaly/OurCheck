...
Route::get('/add_pricing_view',[AdminController::class,'add_pricing_view']);
...
Route::get('/paiment_page/{id}',[HomeController::class,'paiment_page']);
...
Route::get('/updatePricing/{id}',[AdminController::class,'updatePricing']);

Route::get('/updateUser/{id}',[AdminController::class,'updateUser']);

Route::post('/editcheck/{id}',[AdminController::class,'editcheck']);

Route::post('/editPricing/{id}',[AdminController::class,'editPricing']);
...
Route::get('/deleteMssj/{id}',[AdminController::class,'deleteMssj']);
...
Route::get('/clear-table', [HomeController::class, 'clearTable'])->name('Effacer_tableau');

Route::post('/upload_message',[HomeController::class,'upload_message']);

Route::get('/show_message',[AdminController::class,'show_message']);

Route::get('/view_message/{id}',[AdminController::class,'view_message']);

Route::get('/Confirm_Payment',[HomeController::class,'Confirm_Payment']);

Route::get('/deletePricing/{id}',[AdminController::class,'deletePricing']);
